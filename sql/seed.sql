...
-- Tên danh mục theo 4 ngôn ngữ
INSERT INTO ProductCategoryTranslation(ProductCategoryID, LanguageID, CategoryName) VALUES
-- ID 1
(1,'vi','Điện thoại'), (1,'en','Phones'), (1,'ja','電話'), (1,'cn','手机'),
-- ID 2
(2,'vi','Phụ kiện'),  (2,'en','Accessories'), (2,'ja','アクセサリー'), (2,'cn','配件'),
-- ID 3
(3,'vi','Laptop'),    (3,'en','Laptops'), (3,'ja','ノートPC'), (3,'cn','笔记本电脑'),
-- ID 4
(4,'vi','Phần mềm'),  (4,'en','Software'), (4,'ja','ソフトウェア'), (4,'cn','软件');
...
(7,'cn','笔记本 L5','Core i5，16GB 内存，512GB SSD'),
...
(8,'cn','笔记本 Pro 14','Core i7，14英寸 Retina 屏幕'),
...
(9,'cn','游戏本 Z','RTX 4060，15.6英寸 144Hz 屏幕'),
